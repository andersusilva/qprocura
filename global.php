...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de idiomas globais
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas pelo site global.
    | Não substituir nada que esteja entre tag html <> e não traduzir os campos com :nomedealgo
    | pois são informações chaves, cadastradas em variáveis globais do sistema.
    | a \ é scape, por exemplo user\'s, senão fecharia a tag da tradução.
    */
    
    'Free local classified ads in the World' => 'Classificados de Anúncios Locais Gratuitos no Brasil e no Mundo',
    'Free local classified ads in :location' => 'Classificados de Anúncios Locais em :location',
	'Sell and buy near you' => 'Comprar e Vender perto de você',
	'Simple, fast and efficient' => 'Simples, rápido e eficiente',
    'Daily good deals' => 'Boas ofertas diariamente',
    'Daily good deals in :location' => 'Boas ofertas diariamente em :location',
    'Looking for a product or service' => 'Procurando um produto ou serviço',
    'Post your Free Ads here' => 'Publique aqui os seus anúncios grátis',
    'Make your deal Now!' => 'Faça negócios agora!',
    'Free Ads' => 'Anúncios grátis',
    'Free ads' => 'Anúncios grátis',
    'Free ads in' => 'Anúncios grátis em',
    'Free ads in :location' => 'Anúncios grátis em :location',
    'Free ads in :category' => 'Anúncios grátis na :category',
    'Free ads :category in :location' => 'Anúncios grátis :category em :location',
    'Search for' => 'Pesquisar por',
    'free ads' => 'Anúncios grátis',
    'free ads in' => 'Anúncios grátis em',
    'Latest free ads' => 'Últimos anúncios grátis',
    ':count free local classified ads' => ':count Anúncios locais gratuitos',
    ':count free local classified ads in :location' => ':count anúncios locais gratuitos em <strong>:location</strong>',
    '100% Free local classified ads' => 'Classificados de Anúncios Locais 100% gratuitos',
    'Free ads in the World' => 'Anúncios grátis no mundo',
    'Select a country' => 'Selecione um país',
    'Select your country to start' => 'Selecione seu país para começar',
    'I\'m looking for a ...' => 'Eu estou procurando uma...',
    'Location (City) ...' => 'Localização (Cidade)...',
    'What?' => 'O que?',
    'Where?' => 'Aonde?',
    'Select your Location' => 'Selecione sua localização',
    'Please select your location before' => 'Por favor, selecione sua localização primeiro',
    'Find' => 'Encontrar',
    'Search' => 'Procurar',
    'Sell and Buy your products and services on :app_name in Minutes' => '<strong>Venda</strong> e <strong>Compre</strong> seus produtos e serviços no :app_name in Minutes',
    'Sell, Buy and Rent your products and services on :app_name in Minutes' => '<strong>Venda</strong>, <strong>Compre</strong> ou <strong>Alugue</strong> seus produtos e seviços no :app_name em Minutos',
    'Sell and Buy products and services on :app_name in Minutes' => '<strong>Venda</strong> e <strong>Compre</strong> produtos e serviços no :app_name in Minutes',
    'Sell, Buy and Rent products and services on :app_name in Minutes' => '<strong>Venda</strong>, <strong>Compre</strong> ou <strong>Alugue</strong> produtos e seviços no :app_name em Minutos',
    'Post Free Ads' => 'Publicar Anúncios Grátis',
    'Start Now!' => 'Comece agora!',
    'e.g. Smartphone' => 'por ex. Smartphone',
    ...
    'Urgent' => 'Urgente',
    'Urgent Ads only' => 'Apenas Anúncios Urgentes',
    ':app_name is also available in your country: :country. Starting good deals here now!' => ':app_name também está disponível no seu país: <a href=":url"><strong>:country</strong></a>. Iniciando bons negócios <a href=":url"><strong>aqui</strong></a> e agora!',
    'Login for faster access to the best deals. Click here if you don\'t have an account.' => '<a href=":login_url"><strong>Login</strong></a> para acesso mais rápido às melhores ofertas. <a href=":register_url"><strong>Clique aqui</strong></a> se você não tem uma conta.',
    'List of Categories and Sub-categories' => 'Lista de Categorias e Sub-categorias',
    'List of Cities in' => 'Lista de Cidades em',
    'Do have anything to sell or rent?' => 'Tem algo para vender ou alugar?',
    'Sell your products and services online FOR FREE. It\'s easier than you think !' => 'Venda seus produtos e serviços online GRATUITAMENTE. É mais fácil do que você pensa!',
    
    'footer_note' => '<strong>Venda</strong>, <strong>Ofereça</strong>, <strong>Alugue</strong>, <strong>Barganhe</strong>, <strong>Pesquise</strong>, <strong>Compre</strong> ou <strong>Alugue</strong> produtos e serviços em <strong>:country</strong>. É 100% grátis!',
    'Home' => 'Início',
    'About us' => 'Sobre Nós',
    'FAQ' => 'FAQ',
    'Sitemap' => 'Mapa do Site',
    'I am abroad' => 'Estou no exterior',
    'Countries' => 'Países',
    'Terms' => 'Termos',
    'Privacy' => 'Privacidade',
    ...
    'Don\'t have an account?' => 'Você não possui uma conta?',
    'Signup' => 'Inscrever-se',
    ...
    // Signup
    'Create your account, Its free' => 'Crie sua conta, é 100% grátis',
    'Gender' => 'Gênero',
    'Select a gender' => 'Selecione um sexo',
    'Male' => 'Masculino',
    'Female' => 'Feminino',
    'Mr' => 'Sr',
    'Mrs' => 'Sra',
    ...
    'Email' => 'E-mail',
    'Please repeat your password' => 'Repita sua senha',
    'At least :num characters' => 'Pelo menos :num caracteres',
    'I have read and agree to the <a :attributes>Terms & Conditions</a>' => 'Eu li e concordo com os <a :attributes>Termos & Condições</a>',
    ...
    'By continuing on this website, you accept our <a :attributes>Terms of Use</a> and Posting Rules' => 'Ao continuar neste site, você aceita nossos <a :attributes>Termos de Uso</a> e regras de postagem',
    'Register' => 'Registrar',
    ...
    'Post a Free Classified' => 'Publique um anúncio grátis',
    'Do you have something to sell, to rent, any service to offer or a job offer? Post it at :app_name, its free, local, easy, reliable and super fast!' => 'Você tem algo para vender, alugar, algum serviço a oferecer ou uma oferta de emprego? Publique em :app_name, é grátis, para empresas locais e muito fácil de usar!',
    'Create and Manage Items' => 'Criar e gerenciar itens',
    'Become a best seller or buyer. Create and Manage your ads. Repost your old ads, etc.' => 'Torne-se um vendedor top ou comprador assíduo. Crie e gerencie seus anúncios. Rever seus anúncios antigos e etc.',
    'Create your Favorite ads list.' => 'Crie sua lista de anúncios favoritos.',
    'Create your Favorite ads list, and save your searches. Don\'t forget any deal!' => 'Crie sua lista de anúncios favoritos. E salve sua pesquisa. Não se esqueça que antes de qualquer acordo, deverá verificar as avaliações do vendedor.',
	...
	'Picture #:number' => 'Imagem #:number...',
	'Login with LinkedIn' => 'Logar com <strong>LinkedIn</strong>',
